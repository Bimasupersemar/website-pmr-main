...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if($foto_name){
            ...
            $foto_name = "pengurus_".time()."_".$foto_name;
        ...
        if($id != ""){
            $sql1   = "update pengurus set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        }else{
            $sql1       = "insert into pengurus(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data pengurus</h1>
<div class="mb-3 row">
    <a href="pengurus.php">
        << Kembali ke halaman admin pengurus</a>
</div>
<?php
if ($error) {
?>
